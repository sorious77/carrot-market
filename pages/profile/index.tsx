    ...
    <div className="p-3 py-6">
      ...
      <div className="flex justify-around my-10">
        <div className="flex flex-col justify-center items-center cursor-pointer">
          <div className="bg-orange-500 text-white rounded-full p-4 hover:bg-orange-600 focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
          ...
          <span className="text-sm mt-2 text-gray-600">판매내역</span>
        </div>
        <div className="flex flex-col justify-center items-center cursor-pointer">
          <div className="bg-orange-500 text-white rounded-full p-4 hover:bg-orange-600 focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
            <svg
          ...
          <span className="text-sm mt-2 text-gray-600">구매내역</span>
        </div>
        <div className="flex flex-col justify-center items-center cursor-pointer">
          <div className="bg-orange-500 text-white rounded-full p-4 hover:bg-orange-600 focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
            <svg
          ...
          <span className="text-sm mt-2 text-gray-600">관심목록</span>
        </div>
      </div>
      <div>
        <div className="flex">
          <div className="w-10 h-10 rounded-full bg-gray-500" />
          <div className="ml-4 flex text-sm flex-col">
            <h4 className="font-medium">니꼬</h4>
            <div className="flex">
              <svg
